...
- добавлена фича [#181](https://github.com/Security-Experts-Community/vscode-xp/issues/181) - редактирование заполнения табличного списка типа Справочки значениями по умолчанию (special thanks @aw350m3);
- исправлена ошибка компиляции пакета при сокращенном пути (с помощью тильды) к домашней директории пользователя (special thanks @r0mka_Ch);
- локализовано на английский язык окно создания правила по шаблону;
