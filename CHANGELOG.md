...
- PoC фичи [#44](https://github.com/Security-Experts-Community/vscode-xp/issues/44) добавлена подсветка кода теста в интеграционных тестах с её обновлением в процессе редактирования;
- добавлена поддержка символа табуляции для выравнивания кода теста в интеграционных тестах;
- поле нормализованного события теперь readonly;
- добавлена валидация путей на наличие пробелов и кириллицы (special thanks @gautama_s за кейс).
