...
- конструкция `table_list default` (подгружает заполнения по умолчанию для всех справочников) добавлена во все интеграционные тестых всех шаблонов корреляционных правил и автоматически добавляется при создании нового интеграционного теста;
...
- добавлена подсветка функций в в описания функций, возникающем при наведении на функцию в коде;
