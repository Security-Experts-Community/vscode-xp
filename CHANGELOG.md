...
- добавлен единый интерфейс запуска и редактирования модульных тестов для корреляций и нормализаций
- классы модульных тестов наследуются от единого базового класса
- внесены изменения для корректной работы в linux-окружении
