...
- после запуска интеграционных тестов или тестов локализации отображается статус правила в дереве контента с необходимым описанием;
- добавлена проверка в редакторе локализаций на наличие локализации по умолчанию, что является ошибкой;
...
- добавлена функция проверки правил в выбранной директории через `ПКМ на директории-> Проверить` без рекурсии.

## 3.9.4 (Pre-Release)

- расширение адаптировано для KBТ (бандл зависимых бинарных утилит) версий 26.0.4369 и 26.0.346;
