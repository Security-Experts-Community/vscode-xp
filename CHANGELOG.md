...
## 3.3.22
- Проверяем систему публикации Pre-Release сборок.

## 3.3.21

- добавлена валидация ошибок присвоения полей события в блоках on/emit;
- закрыт [#108](https://github.com/Security-Experts-Community/vscode-xp/issues/108) - вывод статуса интеграционных тестов;
- добавлена поддержка корректной кодировки ошибок при запуске интеграционных тестов;
