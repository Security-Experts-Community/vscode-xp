...
- ObjectID табличного списка при генерации учитывает не только его имя но и тип, что позволяет избежать ошибок при изменении типа табличного списка при установке в PTKB (special thanks @DuckDarkwing).
