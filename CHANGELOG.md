...
- интеграционных и модульные тесты работают для баз знаний без табличных списков;
- добавлена возможность сохранять интерграционные тесты по нажатию комбинации `CTRL + S`.
