...
- PoC фичи [#146](https://github.com/Security-Experts-Community/vscode-xp/issues/146) - получение фактического и ожидаемого событий в интеграционных тестах с помощью кнопки `Сравнить полученные результаты` для непрошедших тестов;
