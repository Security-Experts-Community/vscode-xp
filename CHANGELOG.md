...
- в интеграционных тестах перенесена кнопка `Получить ожидаемое событие` ближе к кода теста, для которого она применяется;
- добавлен PoC фичи по получению отличий фактического и ожидаемого события в интеграционных тестах с помощью кнопки `Сравнить полученные результаты`.
