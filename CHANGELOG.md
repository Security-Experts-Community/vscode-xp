...
- обновлена webView модульных тестов нормализаций и корреляций (special thanks @iam_bdoxhn);
- добавлена возможность пересобрать граф нормализаций (Дерево контента → ... → Компилировать все нормализации);
- добавлен бинарный модуль (исходный код [тут](https://github.com/Security-Experts-Community/rust-evtx-convert)) для преобразования evtx-файлов в нужный формат.
