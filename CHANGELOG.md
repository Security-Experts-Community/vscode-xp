...
- добавлена автоматическая пересборка графа нормализаций в том случае, если обнаружены измененные хотя бы одной формулы нормализации в git;
- исключены излишние обновления файлов локализации и метаинформации;
- исключено перезапись Output лога при запуске и отрытии модульных тестов.
