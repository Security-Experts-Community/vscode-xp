...
- улучшена логика сохранения пустых полей в окне редактирования значений по умолчанию табличных списков типа _Справочник_.
- исправлена ошибка при добавлении конверта на xml-событие из EventViewer.
