...
- PoC фичи [#140](https://github.com/Security-Experts-Community/vscode-xp/issues/140) - функция проверки правил в выбранной директории через `ПКМ на директории -> Проверить` без рекурсии;
- если обогащение работает только с нормализованными событиями, то граф корреляций не собирается и данный вопрос пользователю не задается.
