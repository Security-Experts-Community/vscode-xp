...
- Исправлено создание обогащения из шаблона Empty
- При создании корреляций, обогащений и нормализаций учитывается родительский путь. Если создают из котекстного меню пакета, то в путь подставляется папка с названием типа правила (например, correlation_rules). Если создают из контекстного меню папки с названием типа правила, то к пути не добавляется повторное название типа правила.
- Исправлена проверка наличия множественных условий в модульных тестах корреляций и обогащений
