...
- исправлен баг [#137](https://github.com/Security-Experts-Community/vscode-xp/issues/137) - добавлена проверка на генерацию ожидаемого события для тестов c проверкой `expect not {}`;
- добавлены сниппеты для доступа к файлам для Windows и Linux;
- исправлена ошибка генерации примеров локализаций в правиле с множественным использованием одного сабруля.
