...
- улучшена локализация ошибок в расширении, добавлены рекомендации по их разрешению;
- исправлен баг [#137](https://github.com/Security-Experts-Community/vscode-xp/issues/137) - добавлена проверка на генерацию ожидаемого события для тестов в проверкой `expect not {}`;
- добавлены сниппеты для доступа к файлам для Windows и Linux.
...
- исправлен раъезд разметки при проверке локализаций (special thanks @iam_bdoxhn).
