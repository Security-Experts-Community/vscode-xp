...
- если не удалось получить ожидаемое правило корреляции, то по кнопке `Сравнить полученные результаты` в интеграционных тестах теперь будут все полученные события.
